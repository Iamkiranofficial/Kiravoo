...
export default function Home() {
  ...
  async function generate() {
    ...
    setStatus("generating"); setError(""); setVideoUrl(""); setStage(`${assistant.name} is directing your render…`);
    try {
